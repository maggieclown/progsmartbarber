    ...
    private static void crearTablas() throws Exception {
        ...
        try (Statement st = conn.createStatement()) {
            ...
            sql = "CREATE TABLE IF NOT EXISTS Productos ("
                    ...
                    + "CONSTRAINT fk_Productos_Empleados FOREIGN KEY (dni_empleado) REFERENCES Empleados(dni) ON DELETE CASCADE)";
            st.executeUpdate(sql);
            ...
            sql = "CREATE TABLE IF NOT EXISTS Facturas ("
                    ...
                    + "CONSTRAINT fk_id_producto FOREIGN KEY (id_producto) REFERENCES Productos(id) ON DELETE NO ACTION,"
                    + "CONSTRAINT fk_dni_empleado FOREIGN KEY (dni_empleado) REFERENCES Empleados(dni) ON DELETE NO ACTION)";
            st.executeUpdate(sql);

        } catch (SQLException e) {
            throw new Exception("Error en crearTablas()", e);
        }
    }
